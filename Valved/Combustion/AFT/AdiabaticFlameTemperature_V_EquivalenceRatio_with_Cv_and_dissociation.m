...
% specific internal energy for each molecule, and setting internal energy of reactants = 
% internal energy of products. Dissociation is accounted for using equilibrium constants (Kp) 
% derived from NASA polynomials
clear;
clc;
...
ylabel('T_{ad} (K)');
title('Adiabatic Flame Temperature vs Equivalence Ratio (Cv, with dissociation)');
...
function F = equilibrium(vars, x, NASA, Tref, uf, P, R)
    ...
    % Energy balance using internal energy
